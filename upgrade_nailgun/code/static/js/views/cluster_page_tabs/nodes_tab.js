...
function($, _, utils, models, commonViews, ClusterNodesScreen, AddNodesScreen, EditNodesScreen, EditNodeDisksScreen, EditNodeInterfacesScreen) {
    ...
    NodesTab = commonViews.Tab.extend({
        ...
        changeScreen: function(NewScreenView, screenOptions) {
            ...
            //alert(this.tabOptions[0]);
            if (this.tabname == "interfaces")
            {   
                var NewScreenComponent = this.getAvailableScreens()["interfaces"];
                (NewScreenComponent.fetchData ? NewScreenComponent.fetchData(options) : $.Deferred().resolve())
                    .done(_.bind(function(data) {
                        //console.log('这里是回调取回的data数据');
                        //console.log(data);
                      ...
                      if (this.screen) {
                          ...
                          this.$el.fadeOut('fast', _.bind(function() {
                            //console.log("nodes_tab.js options55555");
                            //console.log(options)  
        ...
        routeScreen: function(options) {
            ...
            if(options[0]=="interfaces") {this.tabname = "interfaces";}
