...
#             pass
        ...
        if 'neutron-server' in activeRoles:
            neutron_ip_list = activeRoleIPMap['neutron-server']
            restartNeutronCmd = 'systemctl restart neutron-server'
            for ip in neutron_ip_list:
                execRemoteCmd(ip, restartNeutronCmd, timeout=600)
                pass
            pass
        ...
        if 'glance' in activeRoles:
            ...
            for ip in glance_ip_list:
                execRemoteCmd(ip, syncImageCmd, timeout=1200)
                pass
            pass
        ...
        if 'neutron-agent' in activeRoles:
            ...
            restartL3AgentCmd = 'service neutron-l3-agent restart'
            for ip in network_ip_list:
                execRemoteCmd(ip, restartL3AgentCmd, timeout=600)
                pass
            pass
