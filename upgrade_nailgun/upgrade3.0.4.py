...
#先判断是否存在此列
checkcmd="select count(*) from information_schema.columns WHERE  table_name ='nodes' and  column_name='user_set'"

sqlcmd2="ALTER TABLE nodes add user_set text DEFAULT '{\"mysql_disk\":\"\",\"var_dir_disk\":\"\"}'"
engine.execute(sqlcmd2)
# checkresult=engine.execute(checkcmd)
# if checkresult:
# 	print("nodes表中已经存在user_set字段,跳过....")
# else:
# 	print("给nodes表添加user_set列")
# 	sqlcmd2="ALTER TABLE nodes add user_set text DEFAULT '{\"mysql_disk\":\"\",\"var_dir_disk\":\"\"}'"
